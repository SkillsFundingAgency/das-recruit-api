...
CREATE TABLE dbo.[Vacancy] (
    ...
    INDEX [IX_Vacancy_Account_Owner_Status_TransferInfo] NONCLUSTERED(AccountId, OwnerType, Status, TransferInfo) INCLUDE(Ukprn) WHERE TransferInfo <> null,
    ...
    INDEX [IX_Vacancy_Ukprn_Owner_Status_TransferInfo] NONCLUSTERED(Ukprn, OwnerType, Status, TransferInfo) INCLUDE(AccountId) WHERE TransferInfo <> null,
