...
CREATE TABLE dbo.[Vacancy] (
    ...
    INDEX [IX_Vacancy_List_Provider] ON [dbo].[Vacancy] ([DeletedDate], [OwnerType], [Ukprn], [Status]) INCLUDE ([ApplicationMethod], [ApprenticeshipType], [ClosingDate], [CreatedDate], [HasSubmittedAdditionalQuestions], [LegalEntityName], [Title], [TransferInfo], [VacancyReference]) Where OwnerType = 'Provider' AND DeletedDate IS null
    INDEX [IX_Vacancy_List_Employer] ON [dbo].[Vacancy] ([DeletedDate], [OwnerType], [AccountId], [Status]) INCLUDE ([ApplicationMethod], [ApprenticeshipType], [ClosingDate], [CreatedDate], [HasSubmittedAdditionalQuestions], [LegalEntityName], [Title], [TransferInfo], [VacancyReference]) Where OwnerType = 'Employer' AND DeletedDate IS null
    )