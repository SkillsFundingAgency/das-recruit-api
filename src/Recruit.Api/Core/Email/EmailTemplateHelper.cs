...
{
    private record TemplateKey(NotificationTypes Type, NotificationFrequency? Frequency = null, UserType? UserType = null);
    ...
    public EmailTemplateHelper(string environmentName)
    {
        if (environmentName.Equals("PRD", StringComparison.CurrentCultureIgnoreCase))
        {
            ...
            _templateMap = new Dictionary<TemplateKey, Guid> {
                [new TemplateKey(NotificationTypes.ApplicationSharedWithEmployer)] = new("53058846-e369-4396-87b2-015c9d16360a"),
                ...
                [new TemplateKey(NotificationTypes.SharedApplicationReviewedByEmployer)] = new("2f1b70d4-c722-4815-85a0-80a080eac642"),
                [new TemplateKey(NotificationTypes.VacancySentForReview)] = new("2b69c0b2-bcc0-4988-82b6-868874e5617b"),
                [new TemplateKey(NotificationTypes.VacancyApprovedOrRejected)] = new("c35e76e7-303b-4b18-bb06-ad98cf68158d"),
            };
        ...
        else
        {
            ...
            _templateMap = new Dictionary<TemplateKey, Guid> {
                [new TemplateKey(NotificationTypes.ApplicationSharedWithEmployer)] = new("f6fc57e6-7318-473d-8cb5-ca653035391a"),
                ...
                [new TemplateKey(NotificationTypes.SharedApplicationReviewedByEmployer)] = new("feb4191d-a373-4040-9bc6-93c09d8039b5"),
                [new TemplateKey(NotificationTypes.VacancySentForReview)] = new("83f6cede-31c3-4dc9-b2ec-922856ba9bdc"),
                [new TemplateKey(NotificationTypes.VacancyApprovedOrRejected)] = new("c445095e-e659-499b-b2ab-81e321a9b591"),
            };
    ...
    public Guid GetTemplateId(NotificationTypes notificationType)
    {
        return _templateMap.TryGetValue(new TemplateKey(notificationType), out var templateId)
            ? templateId
            : throw new ArgumentException($"Template has not been defined for the notification type '{notificationType}'");
    }
    ...
    public Guid GetTemplateId(NotificationTypes notificationType, NotificationFrequency notificationFrequency, UserType userType)
    {
        return _templateMap.TryGetValue(new TemplateKey(notificationType, notificationFrequency, userType), out var templateId)
            ? templateId
            : throw new ArgumentException($"Template has not been defined for the notification type '{notificationType}' with frequency '{notificationFrequency}' and user type '{userType}'");
    }
