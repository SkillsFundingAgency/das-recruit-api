...
{
    [Test, AutoData]
    public void Then_The_Wage_Is_Correctly_Calculated_For_Apprentice_Minimum_Wage(Vacancy vacancy)
    {
        vacancy.Wage.WeeklyHours = 37.5m;
        vacancy.Wage.WageType = WageType.NationalMinimumWageForApprentices;
    ...
    [Test, AutoData]
    public void Then_The_Wage_Is_Correctly_Calculated_For_Minimum_Wage(Vacancy vacancy)
    {
        vacancy.Wage.WeeklyHours = 37.5m;
