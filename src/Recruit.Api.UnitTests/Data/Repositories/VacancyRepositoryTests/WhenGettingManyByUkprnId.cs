...
internal class WhenGettingManyByUkprnId
{
    ...
    public void SetUp()
    {
        ...
        {
            new VacancyEntity { Id = Guid.NewGuid(), OwnerType = OwnerType.Provider, Ukprn = 123, Title = "Vac A", ClosingDate = new DateTime(2025, 1, 1), Status = VacancyStatus.Approved, VacancyReference = 1},
            new VacancyEntity { Id = Guid.NewGuid(), OwnerType = OwnerType.Provider, Ukprn = 123, Title = "Vac B", ClosingDate = new DateTime(2025, 2, 1), Status = VacancyStatus.Approved, VacancyReference = 2 },
            new VacancyEntity { Id = Guid.NewGuid(), OwnerType = OwnerType.Provider,  Ukprn = 123, Title = "Vac C", ClosingDate = new DateTime(2025, 3, 1), Status = VacancyStatus.Closed, VacancyReference = 3 },
            new VacancyEntity { Id = Guid.NewGuid(), OwnerType = OwnerType.Provider, Ukprn = 999, Title = "Other Ukprn", ClosingDate = new DateTime(2025, 4, 1), Status = VacancyStatus.Live, VacancyReference = 4 }
        });
