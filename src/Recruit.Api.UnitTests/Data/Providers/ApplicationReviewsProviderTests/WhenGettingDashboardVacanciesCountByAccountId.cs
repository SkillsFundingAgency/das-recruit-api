...
internal class WhenGettingDashboardVacanciesCountByAccountId
{
        ...
        [Greedy] ApplicationReviewsProvider provider)
    {
        ...
        // Act
        var result = await provider.GetPagedByAccountAndStatusAsync(accountId, pageNumber, pageSize, nameof(ApplicationReviewEntity.CreatedDate), false, [ApplicationReviewStatus.New, ApplicationReviewStatus.Shared]);
        ...
        [Greedy] ApplicationReviewsProvider provider)
    {
        ...
        // Act
        var result = await provider.GetPagedByAccountAndStatusAsync(accountId, pageNumber, pageSize, nameof(ApplicationReviewEntity.CreatedDate), false, [status]);
        ...
        [Greedy] ApplicationReviewsProvider provider)
    {
        ...
        // Act
        var result = await provider.GetPagedByAccountAndStatusAsync(accountId, pageNumber, pageSize, sortColumn, isAscending, [status]);
