...
*Organisation Status* | **GET**<br>/api/status/providers/{ukprn} | Ukprn is required.<br><br>If supplied a valid Ukprn, will return if the Ukprn is currently blocked from being able to operate on the SDigital Apprenticeship Service Recruitment sub-system.
